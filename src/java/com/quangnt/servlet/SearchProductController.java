...
public class SearchProductController extends HttpServlet {
    ...
    private static final String SUCCESS = "backend/products/find.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Product> list = productDAO.getProductByName(searchText);
            if (list!=null) {
                request.setAttribute("LIST_PRODUCT_CATEGORY", list);
                url = SUCCESS;
            }
        } catch (Exception e) {
