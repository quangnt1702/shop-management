...
public class SearchCategoryController extends HttpServlet {
    ...
    private static final String SUCCESS = "backend/categories/find.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Category> list=categoryDAO.getCategoryByName(searchText);
            if (list != null) {
                request.setAttribute("LIST_SEARCH_CATEGORY", list);
                url = SUCCESS;
            }
        } catch (Exception e) {
